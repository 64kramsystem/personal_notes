...
| ----- | ------- | ------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0NNN  | Call    |                                                        | Calls machine code routine ([RCA 1802](/wiki/RCA_1802 "RCA 1802") for COSMAC VIP) at address NNN. Not necessary for most ROMs.                                                                                                                                                                                                                                                          |
...
| 8XY6* | BitOp   | Vx>>=1                                                 | Stores the least significant bit of VX in VF and then shifts VX to the right by 1.ᵇ                                                                                                                                                                                                                                                                                                     |
| 8XY7* | Math    | Vx=Vy-Vx                                               | Sets VX to VY minus VX. VF is set to 0 when there's a borrow, and 1 when there isn't.                                                                                                                                                                                                                                                                                                   |
| 8XYE* | BitOp   | Vx<<=1                                                 | Stores the most significant bit of VX in VF and then shifts VX to the left by 1.ᵇ                                                                                                                                                                                                                                                                                                       |
...
- ᵇ) CHIP-8's opcodes 8XY6 and 8XYE (the bit shift instructions), which were in fact undocumented opcodes in the original interpreter, shifted the value in the register VY and
     stored the result in VX. The CHIP-48 and SCHIP implementations instead ignored VY, and simply shifted VX.[9]
